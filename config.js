 ...
 "BOOKOFF 大野城三笠川店→Hard Off & Hobby Off 春日白水店": {
  ...
  "stores": [
   ...
   },
   {
    ...
    "icon": "🍛",
    "cat": "丼飯",
    "branch": "松屋 那珂川店（松のや併設）",
    "d2": 15399,
    "detour": 8571,
    "detourMin": 0,
    "lat": 33.521870199999995,
    "lng": 130.41312019999998,
    "open": "00:00",
    "close": "24:00"
   },
   {
  ...
  "stores": [
   {
    ...
    "icon": "🍛",
    "cat": "丼飯",
    "branch": "松屋 久留米国分バイパス店（松のや併設）",
    "d2": 20022,
    "detour": 240,
    "detourMin": 3,
    "lat": 33.2913996,
    "lng": 130.53631339999998,
    "open": "00:00",
    "close": "24:00"
   },
   {
   ...
   },
   {
    ...
    "icon": "📦",
    "cat": "超市",
    "branch": "生鮮＆業務スーパー ボトルワールドOK 久留米東櫛原店",
    "d2": 14715,
    "detour": 0,
    "detourMin": 7,
    "lat": 33.326640499999996,
    "lng": 130.5186862,
    "open": "09:00",
    "close": "21:00"
   },
...
// 12. 真實車程（calculator v5：Routes API 交通感知，dep=預估出發時刻）產生日 2026/7/23
window.DRIVE_TIMES = {
 "福岡國際機場→ＯＲＩＸ國際線店": {
  "min": 4,
  "km": 1.2,
