...
window.CHAIN_STORES = [
  // query = 點按鈕時自動複製到剪貼簿的關鍵字（在 Google Maps「新增停靠站」貼上搜尋）
  { cat: "丼飯", name: "すき家", icon: "🥩", query: "すき家" },
  { cat: "丼飯", name: "吉野家", icon: "🐂", query: "吉野家" },
  { cat: "丼飯", name: "松屋", icon: "🍛", query: "松屋" },
  { cat: "丼飯", name: "なか卯", icon: "🐔", query: "なか卯" },
  { cat: "超市", name: "イオン", icon: "🛒", query: "イオン" },
  { cat: "超市", name: "マックスバリュ", icon: "🛒", query: "マックスバリュ" },
  { cat: "超市", name: "ザ・ビッグ", icon: "🛒", query: "ザ・ビッグ" },
  { cat: "超市", name: "サニー", icon: "🌞", query: "サニー スーパー" },
  { cat: "超市", name: "レガネット", icon: "🚃", query: "レガネット" },
  { cat: "超市", name: "にしてつストア", icon: "🚃", query: "にしてつストア" },
  { cat: "超市", name: "エレナ", icon: "🐟", query: "エレナ スーパー" },
  { cat: "超市", name: "ロピア", icon: "🥩", query: "ロピア" },
  { cat: "超市", name: "業務スーパー", icon: "📦", query: "業務スーパー" },
  { cat: "超市", name: "スーパー（全部）", icon: "🔍", query: "スーパーマーケット" },
  { cat: "挖寶", name: "BOOKOFF", icon: "📚", query: "ブックオフ" },
  { cat: "挖寶", name: "HARD OFF", icon: "🎸", query: "ハードオフ" },
  { cat: "挖寶", name: "OFF HOUSE", icon: "🛋️", query: "オフハウス" },
  { cat: "挖寶", name: "HOBBY OFF", icon: "🧸", query: "ホビーオフ" },
  { cat: "挖寶", name: "SUPER BAZAAR", icon: "🏬", query: "BOOKOFF SUPER BAZAAR" },
];

// 11.（已退役）沿途連鎖店改用 Google Maps 即時「新增停靠站」搜尋，不再預計算繞路距離
