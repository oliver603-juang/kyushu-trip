...
window.RAW_KML_DATA = [
  ...
  },
  {
    ...
    spots: [
      ...
      { sid: "sp037", name: "九州國立博物館", lat: 33.5182175, lon: 130.5384608, desc: "🏛 九州國立博物館（太宰府市石坂4-7-2）。9:30-17:00（末入館 16:30），週一休（8/8 週六正常開館）。常設展一般 ¥700、大學生 ¥350、高中生以下免費。太宰府IC 下交流道約 10 分，館外停車場每次 ¥500。", mapCode: "55 334 716*41", driveTime: "1小時", ticket: { adult: 700, child: 0 } },
  ...
  },
  {
    ...
    spots: [
      ...
      { sid: "sp019", name: "BOOKOFF Saga Nabeshima", lat: 33.2652133, lon: 130.2718048, desc: "鍋島 BOOKOFF。", mapCode: "87 347 386*40", driveTime: "11分", ticket: { adult: 0, child: 0 } },
      { sid: "sp020", name: "佐賀縣立宇宙科學館 夢銀河", lat: 33.1791421, lon: 130.035404, desc: "互動體驗型宇宙科學館。", mapCode: "104 349 105*75", driveTime: "37分", ticket: { adult: 0, child: 0 } },
      { sid: "sp021", name: "Hard Off Sasebo", lat: 33.1586631, lon: 129.7642449, desc: "佐世保 Hard Off。", mapCode: "307 556 599*63", driveTime: "32分", ticket: { adult: 0, child: 0 } },
      { sid: "sp022", name: "未確認生物UMA展（島瀬美術センター）", lat: 33.17277, lon: 129.72066, desc: "UMA 未確認生物展 8/1~8/31 無休。10:00-18:00（17:30 最後入館）。大人當日1,500円/前售1,300円、國高中生1,000円、小學生以下免費。等身大模型+拍照區，可手機拍照。距飯店步行5分。", mapCode: "", driveTime: "10分", ticket: { adult: 1500, child: 0 } },
